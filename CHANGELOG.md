...
* Added logic to inspect reuse identifier returned from LYRUIConversationViewController` delegate and falling back to default if nil.
* Added logic to inspect height returned from `LYRUIConversationViewController` delegate and falling back to default if nil.
