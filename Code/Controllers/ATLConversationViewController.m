...
- (void)fetchLayerMessages
{
    ...
    if ([self.dataSource respondsToSelector:@selector(conversationViewController:configureQuery:)]) {
        query = [self.dataSource conversationViewController:self configureQuery:query];
    }
