...
/**
 ...
 @param clustered A boolean value to determines whether the message cell cooresponding to the footer should be clustered with the previous cell. Messages sent within 60 secconds of each other are clustred.
