...
{
    LYRClient *client = (LYRClient *)[LYRUITestUtilities layerClientMock];
    LYRUIConversationListViewController *controller = [LYRUIConversationListViewController conversationListViewControllerWithLayerClient:client];
